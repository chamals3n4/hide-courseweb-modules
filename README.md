...
To fix this, I built this Chrome extension (with help from ChatGPT). It helps me hide the modules I don’t want to see—now you can do that too!
...
4. Refresh or revisit courseweb.sliit.lk. Only your selected modules will show in the dropdown.

To show all modules again, click **Reset** in the popup.
